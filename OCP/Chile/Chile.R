...
df_chile <- read.csv("C:/Users/Bertold/Downloads/2018-09-20-chile/2018-10-25-digiwhist-cl.csv", header = TRUE, sep = ",", encoding = "Latin-1")
...
df_chile <- df_chile[,-c(4,7,18,19,32,34,35,36,37,38,39,40,41)]
#df_chile$tender_documents_count <- NULL
...
cols <- c(2,3,6,7,14,17,18,21,25,26,27,31)
df_chile2018[,cols] = lapply(df_chile2018[,cols], as.character)

df_chile2018$tender_publications_firstdcontractawarddate <- as.Date(df_chile2018$tender_publications_firstdcontractawarddate)
...
length(which(df_chile2018$bid_price == 0))
...
df_chile2018$tender_cpvs <- gsub('[[:punct:]]', "", df_chile2018$tender_cpvs)
...
#save file
write.csv(df_chile2018,"path/filename.csv")
