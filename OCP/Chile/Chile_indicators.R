...
df_chile$proc_category <- ifelse(is.na(df_chile$proc_category) & df_chile$cl_code_l2 < 45, "goods", df_chile$proc_category)
df_chile$proc_category <- ifelse(is.na(df_chile$proc_category) & df_chile$cl_code_l2 == 45, "works", df_chile$proc_category)
df_chile$proc_category <- ifelse(is.na(df_chile$proc_category) & df_chile$cl_code_l2 > 45, "services", df_chile$proc_category)
...
#bidder3$tennr_yearly <- NA
#bidder3$tennr_yearly <- ifelse(bidder3$ten_year==2014, length(df_chile$ten_id[df_chile$ten_year==2014]), bidder3$tennr_yearly)
#bidder3$tennr_yearly <- ifelse(bidder3$ten_year==2015, length(df_chile$ten_id[df_chile$ten_year==2015]), bidder3$tennr_yearly)
#bidder3$tennr_yearly <- ifelse(bidder3$ten_year==2016, length(df_chile$ten_id[df_chile$ten_year==2016]), bidder3$tennr_yearly)
#bidder3$tennr_yearly <- ifelse(bidder3$ten_year==2017, length(df_chile$ten_id[df_chile$ten_year==2017]), bidder3$tennr_yearly)
#bidder3$tennr_yearly <- ifelse(bidder3$ten_year==2018, length(df_chile$ten_id[df_chile$ten_year==2018]), bidder3$tennr_yearly)


#bidder_yearly <- df_chile %>% group_by(ten_year) %>% filter(is.na(ten_year)==FALSE) %>% summarise(tennr_yearly = length(ten_id))
#bidder3$tennr_yearly <- as.integer(bidder3$tennr_yearly)
#p_bidder3 <- bidder3 %>% group_by(proc_cat, ten_year) %>% filter(is.na(ten_year)==FALSE) %>% mutate(p_bidder3 = ((bidder_count/tennr_yearly)*100))
...
#df_chile <- left_join(df_chile, tbl_proa_sup_pc)
