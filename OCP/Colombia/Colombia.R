...
#set directory
setwd("C:/Users/Bertold/Downloads/columbia-extra")
getwd()
...
df0$ten_proc_method[grepl("*Concurso de méritos*", df0$ten_proc_method)] <- "selective"
df0$ten_proc_method[grepl("*irecta*", df0$ten_proc_method)] <- "direct"
df0$ten_proc_method[grepl("*régimen especial*", df0$ten_proc_method)] <- "selective"
...
df0$ten_proc_method[grepl("*Mínima Cuantía*", df0$ten_proc_method)] <- "selective"
df0$ten_proc_method[grepl("*Mínima cuantía*", df0$ten_proc_method)] <- "selective"
...
df0$ten_proc_method[grepl("*pública*", df0$ten_proc_method)] <- "open"
...
df0$ten_status[df0$ten_status=="Evaluación"] <- "active"
...
df0$ten_proc_cat[df0$ten_proc_cat=="Concesión"] <- "service"
df0$ten_proc_cat[df0$ten_proc_cat=="Interventoría"] <- "service"
...
df0$ten_proc_cat[df0$ten_proc_cat=="Comisión"] <- "service"
df0$ten_proc_cat[df0$ten_proc_cat=="Consultoría"] <- "service"
...
df0$ten_proc_cat[df0$ten_proc_cat=="Empréstito"] <- "service"
...
df1$ca_status[df1$ca_status=="En aprobación"] <- "pending"
...
df2$ten_status[df2$ten_status=="Finalizado el plazo para manifestaciones de interÃ©s"] <- "withdrawn"
df2$ten_status[df2$ten_status=="Lista Corta"] <- "planning"
df2$ten_status[df2$ten_status=="Terminado Anormalmente después de Convocado"] <- "cancelled"
df2$ten_status[df2$ten_status=="Borrador"] <- "planning"
df2$ten_status[df2$ten_status=="Convocado"] <- "planned"
df2$ten_status[df2$ten_status=="Expresión de Interés"] <- "planning"
df2$ten_status[df2$ten_status=="Liquidado"] <- "complete"
df2$ten_status[df2$ten_status=="PublicaciÃ³n para manifestaciones de interÃ©s"] <- "planning"
df2$ten_status[df2$ten_status=="Terminado sin Liquidar"] <- "unsuccessful"

#recode ten_proc_cat
table(df2$ten_proc_method)
df2$ten_proc_method[df2$ten_proc_method=="Asociación Público Privada"] <- "direct"
df2$ten_proc_method[df2$ten_proc_method=="Concurso de Méritos Abierto"] <- "selective"
df2$ten_proc_method[df2$ten_proc_method=="Concurso de Méritos con Lista Corta"] <- "selective"
df2$ten_proc_method[df2$ten_proc_method=="Concurso de Méritos con Lista Multiusos"] <- "selective"
df2$ten_proc_method[df2$ten_proc_method=="Contratación Directa (Ley 1150 de 2007)"] <- "direct"
df2$ten_proc_method[df2$ten_proc_method=="Contratación Mínima Cuantía"] <- "selective"
df2$ten_proc_method[df2$ten_proc_method=="Contratos y convenios con más de dos partes"] <- "limited"
df2$ten_proc_method[df2$ten_proc_method=="Licitación obra pública"] <- "open"
df2$ten_proc_method[df2$ten_proc_method=="Licitación Pública"] <- "open"
df2$ten_proc_method[df2$ten_proc_method=="Régimen Especial"] <- "selective"
df2$ten_proc_method[df2$ten_proc_method=="Selección Abreviada de Menor Cuantía (Ley 1150 de 2007)"] <- "selective"
df2$ten_proc_method[df2$ten_proc_method=="Selección Abreviada del literal h del numeral 2 del artículo 2 de la Ley 1150 de 2007"] <- "selective"
df2$ten_proc_method[df2$ten_proc_method=="Selección Abreviada servicios de Salud"] <- "selective"
...
df2$ten_proc_cat[df2$ten_proc_cat=="Agregación de Demanda"] <- "goods"
df2$ten_proc_cat[df2$ten_proc_cat=="Concesión"] <- "service"
df2$ten_proc_cat[df2$ten_proc_cat=="Interventoría"] <- "service"
df2$ten_proc_cat[df2$ten_proc_cat=="Prestación de Servicios"] <- "service"
df2$ten_proc_cat[df2$ten_proc_cat=="Arrendamiento"] <- "service"
df2$ten_proc_cat[df2$ten_proc_cat=="Consultoría"] <- "service"
df2$ten_proc_cat[df2$ten_proc_cat=="Suministro"] <- "goods"
df2$ten_proc_cat[df2$ten_proc_cat=="Comodato"] <- "service"
df2$ten_proc_cat[df2$ten_proc_cat=="Crédito"] <- "service"
...
part2$ten_status[part2$ten_status=="Finalizado el plazo para manifestaciones de interÃ©s"] <- "withdrawn"
part2$ten_status[part2$ten_status=="Lista Corta"] <- "planning"
part2$ten_status[part2$ten_status=="Terminado Anormalmente despuÃ©s de Convocado"] <- "cancelled"
part2$ten_status[part2$ten_status=="Borrador"] <- "planning"
part2$ten_status[part2$ten_status=="Convocado"] <- "planned"
part2$ten_status[part2$ten_status=="ExpresiÃ³n de InterÃ©s"] <- "planning"
part2$ten_status[part2$ten_status=="Liquidado"] <- "complete"
part2$ten_status[part2$ten_status=="PublicaciÃ³n para manifestaciones de interÃ©s"] <- "planning"
part2$ten_status[part2$ten_status=="Terminado sin Liquidar"] <- "unsuccessful"

#recode ten_proc_cat
table(part2$ten_proc_method)
part2$ten_proc_method[part2$ten_proc_method=="AsociaciÃ³n PÃºblico Privada"] <- "direct"
part2$ten_proc_method[part2$ten_proc_method=="Concurso de MÃ©ritos Abierto"] <- "selective"
part2$ten_proc_method[part2$ten_proc_method=="Concurso de MÃ©ritos con Lista Corta"] <- "selective"
part2$ten_proc_method[part2$ten_proc_method=="ContrataciÃ³n Directa (Ley 1150 de 2007)"] <- "direct"
part2$ten_proc_method[part2$ten_proc_method=="Iniciativa Privada sin recursos pÃºblicos"] <- "direct"
part2$ten_proc_method[part2$ten_proc_method=="LicitaciÃ³n PÃºblica"] <- "open"
part2$ten_proc_method[part2$ten_proc_method=="RÃ©gimen Especial"] <- "selective"
part2$ten_proc_method[part2$ten_proc_method=="SelecciÃ³n Abreviada servicios de Salud"] <- "selective"
...
part2$ten_proc_cat[part2$ten_proc_cat=="AgregaciÃ³n de Demanda"] <- "goods"
part2$ten_proc_cat[part2$ten_proc_cat=="ConcesiÃ³n"] <- "service"
part2$ten_proc_cat[part2$ten_proc_cat=="InterventorÃa"] <- "service"
part2$ten_proc_cat[part2$ten_proc_cat=="PrestaciÃ³n de Servicios"] <- "service"
part2$ten_proc_cat[part2$ten_proc_cat=="Arrendamiento"] <- "service"
part2$ten_proc_cat[part2$ten_proc_cat=="ConsultorÃa"] <- "service"
part2$ten_proc_cat[part2$ten_proc_cat=="Suministro"] <- "goods"
part2$ten_proc_cat[part2$ten_proc_cat=="Comodato"] <- "service"
part2$ten_proc_cat[part2$ten_proc_cat=="CrÃ©dito"] <- "service"
...
part3$ten_status[part3$ten_status=="Finalizado el plazo para manifestaciones de interÃ©s"] <- "withdrawn"
part3$ten_status[part3$ten_status=="Lista Corta"] <- "planning"
part3$ten_status[part3$ten_status=="Terminado Anormalmente despuÃ©s de Convocado"] <- "cancelled"
part3$ten_status[part3$ten_status=="Borrador"] <- "planning"
part3$ten_status[part3$ten_status=="Convocado"] <- "planned"
part3$ten_status[part3$ten_status=="ExpresiÃ³n de InterÃ©s"] <- "planning"
part3$ten_status[part3$ten_status=="Liquidado"] <- "complete"
part3$ten_status[part3$ten_status=="PublicaciÃ³n para manifestaciones de interÃ©s"] <- "planning"
part3$ten_status[part3$ten_status=="Terminado sin Liquidar"] <- "unsuccessful"

#recode ten_proc_cat
table(part3$ten_proc_method)
part3$ten_proc_method[part3$ten_proc_method=="AsociaciÃ³n PÃºblico Privada"] <- "direct"
part3$ten_proc_method[part3$ten_proc_method=="Concurso de MÃ©ritos Abierto"] <- "selective"
part3$ten_proc_method[part3$ten_proc_method=="Concurso de MÃ©ritos con Lista Corta"] <- "selective"
part3$ten_proc_method[part3$ten_proc_method=="ContrataciÃ³n Directa (Ley 1150 de 2007)"] <- "direct"
part3$ten_proc_method[part3$ten_proc_method=="Iniciativa Privada sin recursos pÃºblicos"] <- "direct"
part3$ten_proc_method[part3$ten_proc_method=="LicitaciÃ³n PÃºblica"] <- "open"
part3$ten_proc_method[part3$ten_proc_method=="RÃ©gimen Especial"] <- "selective"
part3$ten_proc_method[part3$ten_proc_method=="SelecciÃ³n Abreviada servicios de Salud"] <- "selective"
...
part3$ten_proc_cat[part3$ten_proc_cat=="AgregaciÃ³n de Demanda"] <- "goods"
part3$ten_proc_cat[part3$ten_proc_cat=="ConcesiÃ³n"] <- "service"
part3$ten_proc_cat[part3$ten_proc_cat=="InterventorÃa"] <- "service"
part3$ten_proc_cat[part3$ten_proc_cat=="PrestaciÃ³n de Servicios"] <- "service"
part3$ten_proc_cat[part3$ten_proc_cat=="Arrendamiento"] <- "service"
part3$ten_proc_cat[part3$ten_proc_cat=="ConsultorÃa"] <- "service"
part3$ten_proc_cat[part3$ten_proc_cat=="Suministro"] <- "goods"
part3$ten_proc_cat[part3$ten_proc_cat=="Comodato"] <- "service"
part3$ten_proc_cat[part3$ten_proc_cat=="CrÃ©dito"] <- "service"
...
part4$ten_status[part4$ten_status=="Finalizado el plazo para manifestaciones de interÃ©s"] <- "withdrawn"
part4$ten_status[part4$ten_status=="Lista Corta"] <- "planning"
part4$ten_status[part4$ten_status=="Terminado Anormalmente despuÃ©s de Convocado"] <- "cancelled"
part4$ten_status[part4$ten_status=="Borrador"] <- "planning"
part4$ten_status[part4$ten_status=="Convocado"] <- "planned"
part4$ten_status[part4$ten_status=="ExpresiÃ³n de InterÃ©s"] <- "planning"
part4$ten_status[part4$ten_status=="Liquidado"] <- "complete"
part4$ten_status[part4$ten_status=="PublicaciÃ³n para manifestaciones de interÃ©s"] <- "planning"
part4$ten_status[part4$ten_status=="Terminado sin Liquidar"] <- "unsuccessful"

#recode ten_proc_method
table(part4$ten_proc_method)
part4$ten_proc_method[part4$ten_proc_method=="AsociaciÃ³n PÃºblico Privada"] <- "direct"
part4$ten_proc_method[part4$ten_proc_method=="Concurso de MÃ©ritos Abierto"] <- "selective"
part4$ten_proc_method[part4$ten_proc_method=="Concurso de MÃ©ritos con Lista Corta"] <- "selective"
part4$ten_proc_method[part4$ten_proc_method=="ContrataciÃ³n Directa (Ley 1150 de 2007)"] <- "direct"
part4$ten_proc_method[part4$ten_proc_method=="Iniciativa Privada sin recursos pÃºblicos"] <- "direct"
part4$ten_proc_method[part4$ten_proc_method=="LicitaciÃ³n PÃºblica"] <- "open"
part4$ten_proc_method[part4$ten_proc_method=="RÃ©gimen Especial"] <- "selective"
part4$ten_proc_method[part4$ten_proc_method=="SelecciÃ³n Abreviada servicios de Salud"] <- "selective"
...
part4$ten_proc_cat[part4$ten_proc_cat=="AgregaciÃ³n de Demanda"] <- "goods"
part4$ten_proc_cat[part4$ten_proc_cat=="ConcesiÃ³n"] <- "service"
part4$ten_proc_cat[part4$ten_proc_cat=="InterventorÃa"] <- "service"
part4$ten_proc_cat[part4$ten_proc_cat=="PrestaciÃ³n de Servicios"] <- "service"
part4$ten_proc_cat[part4$ten_proc_cat=="Arrendamiento"] <- "service"
part4$ten_proc_cat[part4$ten_proc_cat=="ConsultorÃa"] <- "service"
part4$ten_proc_cat[part4$ten_proc_cat=="Suministro"] <- "goods"
part4$ten_proc_cat[part4$ten_proc_cat=="Comodato"] <- "service"
part4$ten_proc_cat[part4$ten_proc_cat=="CrÃ©dito"] <- "service"
...
part5$ten_status[part5$ten_status=="Finalizado el plazo para manifestaciones de interÃ©s"] <- "withdrawn"
part5$ten_status[part5$ten_status=="Lista Corta"] <- "planning"
part5$ten_status[part5$ten_status=="Terminado Anormalmente despuÃ©s de Convocado"] <- "cancelled"
part5$ten_status[part5$ten_status=="Borrador"] <- "planning"
part5$ten_status[part5$ten_status=="Convocado"] <- "planned"
part5$ten_status[part5$ten_status=="ExpresiÃ³n de InterÃ©s"] <- "planning"
part5$ten_status[part5$ten_status=="Liquidado"] <- "complete"
part5$ten_status[part5$ten_status=="PublicaciÃ³n para manifestaciones de interÃ©s"] <- "planning"
part5$ten_status[part5$ten_status=="Terminado sin Liquidar"] <- "unsuccessful"

#recode ten_proc_method
table(part5$ten_proc_method)
part5$ten_proc_method[part5$ten_proc_method=="AsociaciÃ³n PÃºblico Privada"] <- "direct"
part5$ten_proc_method[part5$ten_proc_method=="Concurso de MÃ©ritos Abierto"] <- "selective"
part5$ten_proc_method[part5$ten_proc_method=="Concurso de MÃ©ritos con Lista Corta"] <- "selective"
part5$ten_proc_method[part5$ten_proc_method=="ContrataciÃ³n Directa (Ley 1150 de 2007)"] <- "direct"
part5$ten_proc_method[part5$ten_proc_method=="Iniciativa Privada sin recursos pÃºblicos"] <- "direct"
part5$ten_proc_method[part5$ten_proc_method=="LicitaciÃ³n PÃºblica"] <- "open"
part5$ten_proc_method[part5$ten_proc_method=="LicitaciÃ³n obra pÃºblica"] <- "open"
part5$ten_proc_method[part5$ten_proc_method=="RÃ©gimen Especial"] <- "selective"
part5$ten_proc_method[part5$ten_proc_method=="SelecciÃ³n Abreviada servicios de Salud"] <- "selective"
...
part5$ten_proc_cat[part5$ten_proc_cat=="AgregaciÃ³n de Demanda"] <- "goods"
part5$ten_proc_cat[part5$ten_proc_cat=="ConcesiÃ³n"] <- "service"
part5$ten_proc_cat[part5$ten_proc_cat=="InterventorÃa"] <- "service"
part5$ten_proc_cat[part5$ten_proc_cat=="PrestaciÃ³n de Servicios"] <- "service"
part5$ten_proc_cat[part5$ten_proc_cat=="Arrendamiento"] <- "service"
part5$ten_proc_cat[part5$ten_proc_cat=="ConsultorÃa"] <- "service"
part5$ten_proc_cat[part5$ten_proc_cat=="Suministro"] <- "goods"
part5$ten_proc_cat[part5$ten_proc_cat=="Comodato"] <- "service"
part5$ten_proc_cat[part5$ten_proc_cat=="CrÃ©dito"] <- "service"
...
part6$ten_status[part6$ten_status=="Finalizado el plazo para manifestaciones de interÃ©s"] <- "withdrawn"
part6$ten_status[part6$ten_status=="Lista Corta"] <- "planning"
part6$ten_status[part6$ten_status=="Terminado Anormalmente despuÃ©s de Convocado"] <- "cancelled"
part6$ten_status[part6$ten_status=="Borrador"] <- "planning"
part6$ten_status[part6$ten_status=="Convocado"] <- "planned"
part6$ten_status[part6$ten_status=="ExpresiÃ³n de InterÃ©s"] <- "planning"
part6$ten_status[part6$ten_status=="Liquidado"] <- "complete"
part6$ten_status[part6$ten_status=="PublicaciÃ³n para manifestaciones de interÃ©s"] <- "planning"
part6$ten_status[part6$ten_status=="Terminado sin Liquidar"] <- "unsuccessful"


#recode ten_proc_method
table(part6$ten_proc_method)
part6$ten_proc_method[part6$ten_proc_method=="AsociaciÃ³n PÃºblico Privada"] <- "direct"
part6$ten_proc_method[part6$ten_proc_method=="Concurso de MÃ©ritos Abierto"] <- "selective"
part6$ten_proc_method[part6$ten_proc_method=="Concurso de MÃ©ritos con Lista Corta"] <- "selective"
part6$ten_proc_method[part6$ten_proc_method=="ContrataciÃ³n Directa (Ley 1150 de 2007)"] <- "direct"
part6$ten_proc_method[part6$ten_proc_method=="Iniciativa Privada sin recursos pÃºblicos"] <- "direct"
part6$ten_proc_method[part6$ten_proc_method=="LicitaciÃ³n PÃºblica"] <- "open"
part6$ten_proc_method[part6$ten_proc_method=="RÃ©gimen Especial"] <- "selective"
part6$ten_proc_method[part6$ten_proc_method=="SelecciÃ³n Abreviada servicios de Salud"] <- "selective"
...
part6$ten_proc_cat[part6$ten_proc_cat=="AgregaciÃ³n de Demanda"] <- "goods"
part6$ten_proc_cat[part6$ten_proc_cat=="ConcesiÃ³n"] <- "service"
part6$ten_proc_cat[part6$ten_proc_cat=="InterventorÃa"] <- "service"
part6$ten_proc_cat[part6$ten_proc_cat=="PrestaciÃ³n de Servicios"] <- "service"
part6$ten_proc_cat[part6$ten_proc_cat=="Arrendamiento"] <- "service"
part6$ten_proc_cat[part6$ten_proc_cat=="ConsultorÃa"] <- "service"
part6$ten_proc_cat[part6$ten_proc_cat=="Suministro"] <- "goods"
part6$ten_proc_cat[part6$ten_proc_cat=="Comodato"] <- "service"
part6$ten_proc_cat[part6$ten_proc_cat=="CrÃ©dito"] <- "service"
...
part7$ten_status[part7$ten_status=="Finalizado el plazo para manifestaciones de interÃ©s"] <- "withdrawn"
part7$ten_status[part7$ten_status=="Lista Corta"] <- "planning"
part7$ten_status[part7$ten_status=="Terminado Anormalmente despuÃ©s de Convocado"] <- "cancelled"
part7$ten_status[part7$ten_status=="Borrador"] <- "planning"
part7$ten_status[part7$ten_status=="Convocado"] <- "planned"
part7$ten_status[part7$ten_status=="ExpresiÃ³n de InterÃ©s"] <- "planning"
part7$ten_status[part7$ten_status=="Liquidado"] <- "complete"
part7$ten_status[part7$ten_status=="PublicaciÃ³n para manifestaciones de interÃ©s"] <- "planning"
part7$ten_status[part7$ten_status=="Terminado sin Liquidar"] <- "unsuccessful"

#recode ten_proc_method
table(part7$ten_proc_method)
part7$ten_proc_method[part7$ten_proc_method=="AsociaciÃ³n PÃºblico Privada"] <- "direct"
part7$ten_proc_method[part7$ten_proc_method=="Concurso de MÃ©ritos Abierto"] <- "selective"
part7$ten_proc_method[part7$ten_proc_method=="Concurso de MÃ©ritos con Lista Corta"] <- "selective"
part7$ten_proc_method[part7$ten_proc_method=="ContrataciÃ³n Directa (Ley 1150 de 2007)"] <- "direct"
part7$ten_proc_method[part7$ten_proc_method=="Iniciativa Privada sin recursos pÃºblicos"] <- "direct"
part7$ten_proc_method[part7$ten_proc_method=="LicitaciÃ³n PÃºblica"] <- "open"
part7$ten_proc_method[part7$ten_proc_method=="RÃ©gimen Especial"] <- "selective"
part7$ten_proc_method[part7$ten_proc_method=="SelecciÃ³n Abreviada servicios de Salud"] <- "selective"
...
part7$ten_proc_cat[part7$ten_proc_cat=="AgregaciÃ³n de Demanda"] <- "goods"
part7$ten_proc_cat[part7$ten_proc_cat=="ConcesiÃ³n"] <- "service"
part7$ten_proc_cat[part7$ten_proc_cat=="InterventorÃa"] <- "service"
part7$ten_proc_cat[part7$ten_proc_cat=="PrestaciÃ³n de Servicios"] <- "service"
part7$ten_proc_cat[part7$ten_proc_cat=="Arrendamiento"] <- "service"
part7$ten_proc_cat[part7$ten_proc_cat=="ConsultorÃa"] <- "service"
part7$ten_proc_cat[part7$ten_proc_cat=="Suministro"] <- "goods"
part7$ten_proc_cat[part7$ten_proc_cat=="Comodato"] <- "service"
part7$ten_proc_cat[part7$ten_proc_cat=="CrÃ©dito"] <- "service"
...
part8$ten_status[part8$ten_status=="Finalizado el plazo para manifestaciones de interÃ©s"] <- "withdrawn"
part8$ten_status[part8$ten_status=="Lista Corta"] <- "planning"
part8$ten_status[part8$ten_status=="Terminado Anormalmente despuÃ©s de Convocado"] <- "cancelled"
part8$ten_status[part8$ten_status=="Borrador"] <- "planning"
part8$ten_status[part8$ten_status=="Convocado"] <- "planned"
part8$ten_status[part8$ten_status=="ExpresiÃ³n de InterÃ©s"] <- "planning"
part8$ten_status[part8$ten_status=="Liquidado"] <- "complete"
part8$ten_status[part8$ten_status=="PublicaciÃ³n para manifestaciones de interÃ©s"] <- "planning"
part8$ten_status[part8$ten_status=="Terminado sin Liquidar"] <- "unsuccessful"


#recode ten_proc_method
table(part8$ten_proc_method)
part8$ten_proc_method[part8$ten_proc_method=="AsociaciÃ³n PÃºblico Privada"] <- "direct"
part8$ten_proc_method[part8$ten_proc_method=="Concurso de MÃ©ritos Abierto"] <- "selective"
part8$ten_proc_method[part8$ten_proc_method=="Concurso de MÃ©ritos con Lista Corta"] <- "selective"
part8$ten_proc_method[part8$ten_proc_method=="ContrataciÃ³n Directa (Ley 1150 de 2007)"] <- "direct"
part8$ten_proc_method[part8$ten_proc_method=="Iniciativa Privada sin recursos pÃºblicos"] <- "direct"
part8$ten_proc_method[part8$ten_proc_method=="LicitaciÃ³n PÃºblica"] <- "open"
part8$ten_proc_method[part8$ten_proc_method=="RÃ©gimen Especial"] <- "selective"
part8$ten_proc_method[part8$ten_proc_method=="SelecciÃ³n Abreviada servicios de Salud"] <- "selective"
...
part8$ten_proc_cat[part8$ten_proc_cat=="AgregaciÃ³n de Demanda"] <- "goods"
part8$ten_proc_cat[part8$ten_proc_cat=="ConcesiÃ³n"] <- "service"
part8$ten_proc_cat[part8$ten_proc_cat=="InterventorÃa"] <- "service"
part8$ten_proc_cat[part8$ten_proc_cat=="PrestaciÃ³n de Servicios"] <- "service"
part8$ten_proc_cat[part8$ten_proc_cat=="Arrendamiento"] <- "service"
part8$ten_proc_cat[part8$ten_proc_cat=="ConsultorÃa"] <- "service"
part8$ten_proc_cat[part8$ten_proc_cat=="Suministro"] <- "goods"
part8$ten_proc_cat[part8$ten_proc_cat=="Comodato"] <- "service"
part8$ten_proc_cat[part8$ten_proc_cat=="CrÃ©dito"] <- "service"
...
#take a random sample of the same size az secop II, so that missing rates are not disproportional
secopI_sample <- df_secopI_all_ff[sample(nrow(df_secopI_all_ff), 185000), ]

#secopI_II_sample <- merge(secopI_sample, secopII_s, by = "ca_id", all.x=T)
#although the two file contains the same variable, contract id, they do not belong to the same contract, they do not match
...
write.csv(secopI_sample, file = "secopI_sample.csv", row.names = FALSE)
write.csv(secopI_II, file = "secopI_II.csv", row.names = FALSE)
